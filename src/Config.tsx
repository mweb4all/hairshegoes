...
const welcomeMessage = "Welcome to Hair She Goes Home Salon";
...
const infoParagraphs = [
  "Award-winning styling from a Level 3 NVQ qualified hairdresser with 13 years' experience.", 
  "Specialising in expert colour using Wella Professional products.", 
  "Personalised service in a welcoming salon, where vibrant hair meets trusted expertise."]

const socialLinks: SocialMediaProps["socialLinks"] = {
  facebook: "https://www.facebook.com/HairSheGoesHomeSalon/",
  twitter: null,
  instagram: null
};
...
const openingTimes = {
  ...
  Tuesday: { open: "09:30", close: "14:30" },
...
const pageTitle = "Hair She Goes - Home Salon";
const secondaryTitle = "Medworth - Peterborough"

const templateName = "hairshegoes";

const mainBackgroundImage = `url(/${templateName}/hairshegoesbackground.jpg)`;
const logoImage = `url(/${templateName}/hairshegoeslogo.jpg)`;

const number = "07498 281952";

const googleMap =
 "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2426.488700572327!2d-0.2954483!3d52.54268449999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4877f3fa0f8498a1%3A0x934dfb9ea07b9088!2sHair%20She%20Goes!5e0!3m2!1sen!2suk!4v1752507958969!5m2!1sen!2suk";

 const shadowOffset = 2;

const collageUrl = `url(/${templateName}/hairshegoescollage.jpg)`;
